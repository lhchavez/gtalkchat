...
namespace Gchat.Pages {
    public partial class ContactList : PhoneApplicationPage {
        ...
        private void AllContactsListBox_GroupViewOpened(object sender, GroupViewOpenedEventArgs e) {
        ...
        private void AllContactsListBox_GroupViewClosing(object sender, GroupViewClosingEventArgs e) {
            currentSelector = sender as LongListSelector;
